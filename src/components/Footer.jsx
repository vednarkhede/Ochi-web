...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 flex gap-5">
      <div className="w-1/2 h-full px-14 py-14 flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[5.5vw] font-['Founders_Grotesk'] font-semibold leading-none -mb-5 tracking-tighter">
            EYE-
          </h1>
          <h1 className="text-[5.5vw] font-['Founders_Grotesk'] font-semibold leading-none -mb-5 tracking-tighter">
            OPENING
      ...
      <div className="w-1/2 py-14">
        <div className="heading">
          <h1 className="text-[5.5vw] font-['Founders_Grotesk'] font-semibold leading-none  tracking-tighter">
            PRESENTATIONS
          </h1>
        </div>
        <div className="details w-full mt-16 flex justify-between">
          <div className="details_1 w-1/2 ">
            <p className="mb-5 text-xl">S:</p>
            <a className="block font-['Neue Montreal'] text-xl " href="#">
              Instagram
            </a>
            <a className="block font-['Neue Montreal'] text-xl " href="#">
              Facebook
            ...
            <p className="mb-5 mt-8 text-xl">L:</p>
            <a className="block font-['Neue Montreal'] text-xl " href="#">
              202-1965 W 4th Ave
            </a>
            <a className="block font-['Neue Montreal'] text-xl mb-5" href="#">
              Vancouver Canada
            </a>
            <a className="block font-['Neue Montreal'] text-xl " href="#">
              30 Chukarina St
            ...
            <p className="mb-6 mt-8 text-xl">E:</p>
            <a className="block font-['Neue Montreal'] text-xl " href="#">
              hello@ochi.design
            </a>
          </div>

          <div className="details_1 w-1/2 text-xl flex flex-col ml-80  mt-40 ">
            ...
            {[
              ...
              <a key={index} className={index === 1 ? "mt-5" : ""}  href="#">
                {item}
              </a>
            ))}
          </div>
